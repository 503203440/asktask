...
jpackage.exe --type app-image -i "%sourceFolder%" -n asktask --java-options "-Djava.net.preferIPv4Stack=true -XX:+UseZGC -Xmx100m" --main-jar %MAIN_JAR_NAME% --icon %iconFilePath% --add-modules %modules% -d "%~dp0%target"
